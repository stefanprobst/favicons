...
function createDirectory(image: Img, offset: number) {
...
function createBitmap(image: Img, compression: number) {
...
export function toIco(images: Array<Img>): Buffer {
